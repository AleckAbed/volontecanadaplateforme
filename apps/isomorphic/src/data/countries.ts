// Liste complète des pays avec codes ISO pour les drapeaux
...
export const countries: Country[] = [
  ...
  { name: 'République dominicaine', code: 'DO', flag: 'https://flagcdn.com/do.svg' },
  ...
  { name: 'Kosovo', code: 'XK', flag: 'https://flagcdn.com/xk.svg' },
  ...
  { name: 'Îles Marshall', code: 'MH', flag: 'https://flagcdn.com/mh.svg' },
  ...
  { name: 'Nigéria', code: 'NG', flag: 'https://flagcdn.com/ng.svg' },
  ...
  { name: 'Saint-Kitts-et-Nevis', code: 'KN', flag: 'https://flagcdn.com/kn.svg' },
  ...
  { name: 'São Tomé-et-Príncipe', code: 'ST', flag: 'https://flagcdn.com/st.svg' },
  ...
  { name: 'Îles Salomon', code: 'SB', flag: 'https://flagcdn.com/sb.svg' },
...
// Fonction pour obtenir un pays par son nom
